...
Some Tips and Tricks about SQL.
...
* [FlyWay](https://flywaydb.org/) - An open-source database migration tool, with migrations scripts, repeatables scripts (and undo scripts)
